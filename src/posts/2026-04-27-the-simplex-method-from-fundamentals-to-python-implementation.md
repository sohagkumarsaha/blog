...
x\*{B\_m} & \bar{a}\*{m1} & \cdots & \bar{a}\_{mn} & \bar{b}_m \
...
After pivoting, ( x\_{B\_{i^\*}} ) leaves the basis and ( x_{j^\*} ) enters. Update the basis index list accordingly.
...
\- \*\*c.\*\* Compute ratios ( r\_i = \bar{b}\*i / \bar{a}\*{i j^\*} ) for all ( i ) with ( \bar{a}\_{i j^\*} > 0 ).
